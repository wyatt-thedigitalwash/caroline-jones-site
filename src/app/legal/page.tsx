...
export const metadata: Metadata = {
  ...
  description:
    "Terms and policies for the Caroline Jones official website, operated by Borchetta Entertainment Group, LLC and its affiliates.",
  alternates: { canonical: "https://carolinejones.com/legal" },
...
export default function LegalHubPage() {
  return (
    <section data-bg="primary" className="legal-typeset bg-background-primary px-5 pt-28 pb-20 md:pb-28 lg:px-12">
      <div className="mx-auto max-w-[820px]">
        <h1 className="font-body text-[30px] md:text-[44px]" style={{ color: "var(--text-accent)" }}>
          Legal &amp; Policies
        </h1>
        ...
        <ul className="mt-10 flex flex-col gap-4">
          {POLICIES.map((p) => (
            <li key={p.href}>
              ...
              >
                <span className="font-body text-[20px] text-text-accent md:text-[24px]">{p.title}</span>
