...
export const CATEGORY_META: { key: Category; label: string; locked?: boolean; description: string }[] = [
  ...
  },
  {
    key: "social",
    label: "Social media",
    description: "Enable sharing and content from social media platforms such as Facebook, Instagram, TikTok and YouTube.",
  },
];

export const STORAGE_KEY = "cj-cookie-consent";
